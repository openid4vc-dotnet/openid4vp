...
/// <summary>
/// Credential Query for SD-JWT VC format (vc+sd-jwt, dc+sd-jwt).
/// Specification: OpenID for Verifiable Presentations 1.0, Appendix B.3
/// </summary>
public sealed record SdJwtVcCredentialQuery : DcqlCredentialQuery
{
    [JsonConstructor]
    internal SdJwtVcCredentialQuery() { }

    [JsonIgnore]
    public override string Format => CredentialFormats.VcSdJwt;
